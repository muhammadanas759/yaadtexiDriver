...
import com.yaaddrivertaxi.app.ApiResponse.PastTripDetailResponse.User;
...
public class DisplayProfile extends AppCompatActivity {
    ...
    com.yaaddrivertaxi.app.ApiResponse.UpcomingDetailResponse.User users;
    int no;
    @Override
...
// my_child_toolbar is defined in the layout file
        ...
        if(getIntent()!=null){
            ...
            user= (User) bundle.get("user");
                ...
                users= (com.yaaddrivertaxi.app.ApiResponse.UpcomingDetailResponse.User) bundle.get("user");
        }
